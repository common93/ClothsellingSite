...
namespace ClothingStore.Infrastructure.Migrations
{
    ...
    [Migration("20251116175217_AddWebhookLogs2")]
    partial class AddWebhookLogs2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClothingStore.Core.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ClothingStore.Core.Entities.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClothingStore.Core.Entities.WebhookLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClothingStore.Core.Entities.CartItem", b =>
                {
                    b.HasOne("ClothingStore.Core.Entities.Cart", "Cart")
                        .WithMany("Items")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClothingStore.Core.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ClothingStore.Core.Entities.UserAddress", b =>
                {
                    b.HasOne("ClothingStore.Core.Entities.ApplicationUser", null)
                        .WithMany("Addresses")
